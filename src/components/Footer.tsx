...
const Footer = () => (
  <footer className="bg-navy-deep py-12 border-t border-primary-foreground/10">
    <div className="container mx-auto px-6 flex flex-col gap-8">
      ...
      <div className="flex items-center justify-center gap-6 text-xs text-primary-foreground/40 border-t border-primary-foreground/10 pt-6">
        <Link to="/privacy" className="hover:text-lime transition-colors">Privacy Policy</Link>
        <Link to="/terms" className="hover:text-lime transition-colors">Terms of Service</Link>
      </div>
    </div>
  </footer>
);
